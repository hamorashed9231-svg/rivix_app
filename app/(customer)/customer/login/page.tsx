      ...
      <div className="text-center space-y-3">
        ...
        <div className="space-y-1">
          ...
          <p className="text-xs text-slate-400">
            سجل دخولك واطلب أشهى المأكولات والمشويات مباشرة
          </p>
        </div>
      </div>
...
export default function CustomerLoginPage() {
  return (
    <div className="min-h-screen bg-slate-950 flex items-center justify-center selection:bg-brand-sky selection:text-slate-950">
